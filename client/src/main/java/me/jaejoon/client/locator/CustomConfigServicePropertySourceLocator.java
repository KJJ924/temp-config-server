package me.jaejoon.client.locator;
...
public class CustomConfigServicePropertySourceLocator implements PropertySourceLocator {

    private static Log logger = LogFactory.getLog(CustomConfigServicePropertySourceLocator.class);

    private RestTemplate restTemplate;

    private ConfigClientProperties defaultProperties;

    public CustomConfigServicePropertySourceLocator(ConfigClientProperties defaultProperties) {
        ...
        for (Map.Entry<String, Object> entry : source.entrySet()) {
            ...
            if (entry.getValue() instanceof Map) {
                ...
                if (value.size() == 2 && value.containsKey("origin") && value.containsKey("value")) {
                    Origin origin = new CustomConfigServicePropertySourceLocator.ConfigServiceOrigin(name, value.get("origin"));
